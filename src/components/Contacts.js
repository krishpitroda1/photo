    ...
    <div class=" items-center lg:p-10 pt-0 lg:grid lg:grid-flow-col">
      <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 divs bg-gray-800 text-gray-400">
        ...
        <form ref={form} onSubmit={sendEmail} className=''>
          ...
          <div className='pt-3'>
              <input type="checkbox" /> I agree to all the <a href="">
      ...
      <div class="divide-y divide-gray-200 dark:divide-gray-800 p-5 lg:pl-10">
        <RevealOnScroll><div class="flex gap-x-7 py-6">
         <FaWhatsapp className='flex-shrink-0 w-6 h-6 mt-1.5 text-green-600' />
          <div class="grow">
            <Link  to="https://wa.me/message/ILY4U4LCN4UHP1" className='hover:text-gray-800'>
            ...
            <Link to="https://wa.me/message/ILY4U4LCN4UHP1" target="_blank" class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-blue-900">
              Click here to message us on WhatsApp +919408992449
           </Link>
           </Link>
        ...
        <FaLinkedin className='flex-shrink-0 w-6 h-6 mt-1.5 text-sky-600'/>
          <div class="grow">
            ...
            <Link class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-blue-900 " target="_blank" to="https://www.linkedin.com/company/smscloudhub">
        ...
        <FaInstagram className='flex-shrink-0 w-6 h-6 mt-1.5 text-red-300'/>
          <div class="grow">
            ...
            <Link class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-blue-900 " target="_blank" to="https://www.instagram.com/smscloudhub">
